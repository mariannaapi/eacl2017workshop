...
&  NMI & Unfiltered GAP & Oracle GAP & Unfiltered GAP & Oracle GAP \\ \hline
PPDBClus & 0.254 & 0.528 & 0.661 & 0.533 & 0.656 \\ \cdashline{1-6}[1pt/2pt]
WordNet & 0.252 & 0.528 & 0.655 & 0.533 & 0.651 \\ \hline
Choose-K: \# WN Synsets \footnotesize{(avg)} & 0.205 & 0.528 & 0.639 & 0.533 & 0.636  \\ \cdashline{1-6}[1pt/2pt]
Choose-K: \# WN Synsets \footnotesize{(max, no co-clustering)} & 0.250* & 0.528 & 0.695* & 0.533 & 0.690*  \\ \cdashline{1-6}[1pt/2pt]
Choose-K: \# WN Synsets \footnotesize{(max, co-clustering)} & 0.241** & 0.528 & 0.690** & 0.533 & 0.683**  \\ \hline
Choose-K: Optimize NMI  \footnotesize{(avg)} & 0.282 & 0.528 & 0.668 & 0.533 & 0.662 \\ \cdashline{1-6}[1pt/2pt]
Choose-K: Optimize NMI  \footnotesize{(max, no co-clustering)} & 0.331* & 0.528 & 0.719 * & 0.533 & 0.714 ***  \\ \cdashline{1-6}[1pt/2pt]
Choose K: Optimize NMI \footnotesize{(max, co-clustering)} & 0.314** & 0.528 & 0.718 **** & 0.533 & 0.71 **  \\
\end{tabular}
}
  \caption{\footnotesize{NMI of resulting sense inventories, and GAP scores of the unfiltered and best sense-filtered rankings produced by the Syn.VSM and AddCos models. Configurations for the best-performing sense inventories were: * Min PPDB Score 2.0, cluster PP's only, use PP-PP mask; ** Min PPDB Score 2.0, co-clustering, use PP-PP mask only; *** Min PPDB Score 1.5, cluster PP's only, use PP-PP mask}; **** Min PPDB Score 2.0, co-clustering, use PP-PP, Syn-Syn masks only}
  \label{tab:GAP1}
\end{table*}
...
Further, we find that the NMI substitutability score is a good indicator of how much improvement we see in GAP score due to oracle sense filtering. We calculated the Pearson correlation of a sense inventory's NMI with its oracle GAP score to be 0.644. This suggests that NMI is a reasonable measure of substitutability.
