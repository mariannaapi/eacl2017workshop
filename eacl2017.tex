	...
	\begin{table*}[th]
		...
		\scalebox{0.8}{
			\begin{tabular}{c||c||c|c||c|c}
				...
				Average of all Clustered Sense Inventories & 0.367 &  & 0.841 &  & 0.569 \\ \cdashline{1-2}[1pt/2pt]\cdashline{4-4}[1pt/2pt]\cdashline{6-6}[1pt/2pt]
				Max basic (no co-clustering) sense inventory & 0.448* &  & 0.917*  &  & 0.626*   \\ \cdashline{1-2}[1pt/2pt]\cdashline{4-4}[1pt/2pt]\cdashline{6-6}[1pt/2pt]
